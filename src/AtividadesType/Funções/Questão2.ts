...
export function exercicioFun2():void{
...
function emitir_mensagem_alerta(status_alerta: any){
    if(status_alerta){
        alert("ALERTA: Temperatura fora do ideal!")
    }
    else{
...
let alerta: any = verificar_alerta_temperatura(temp)
